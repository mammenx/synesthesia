...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../dgn/syn/syn_fpga_top.jdi
...
# setting BSP_SYS_LIB is chibios_v240_bsp
BSP_SYS_LIB := chibios_v240_bsp
ELF_PATCH_FLAG  += --thread_model chibios_v240

# Type identifier of the BSP library 
# setting BSP_TYPE is chibios_v240
ALT_CPPFLAGS += -D__hal__
BSP_TYPE := chibios_v240
...
# Design Name 
# setting SOPC_NAME is limbus_sys
SOPC_NAME := limbus_sys
...
# The SOPC System ID 
# setting SOPC_SYSID is 666
SOPC_SYSID_FLAG += --id=666
ELF_PATCH_FLAG  += --id 666

# The SOPC System ID Base Address 
# setting SOPC_SYSID_BASE_ADDRESS is 0x11020c8
SOPC_SYSID_FLAG += --sidp=0x11020c8
ELF_PATCH_FLAG  += --sidp 0x11020c8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1354828801
SOPC_SYSID_FLAG += --timestamp=1354828801
ELF_PATCH_FLAG  += --timestamp 1354828801
...
ALT_INCLUDE_DIRS += $(ALT_LIBRARY_ROOT_DIR)/ChibiOS_v240/kernel/include
ALT_INCLUDE_DIRS += $(ALT_LIBRARY_ROOT_DIR)/ChibiOS_v240/ports/GCC/NiosII
ALT_INCLUDE_DIRS += $(ALT_LIBRARY_ROOT_DIR)/ChibiOS_v240/./
