...
void fft_rec(int N, int offset, int delta,
             double (*x)[2], double (*X)[2], double (*XX)[2], int rec_no);
  ...
  if(N != 2)  /* Perform recursive step. */
    {
      ...
      fft_rec(N2, offset, 2*delta, x, XX, X,rec_no);
      fft_rec(N2, offset+delta, 2*delta, x, XX, X,rec_no);
      ...
      for(k=0; k<N2; k++)
        {
          ...
          //printf("Part - A : K00=%3d\tK01=%3d\t\tK10=%3d\t\tK11=%3d\t\tk=%3d\t\tN=%3d\n",BitReverseTable128[k00],BitReverseTable128[k01],BitReverseTable128[k10],BitReverseTable128[k11],k,N);
  ...
  else  /* Perform 2-point DFT. */
    {
      ...
      //printf("Part - B : K00=%3d\tK01=%3d\n",BitReverseTable128[k00],BitReverseTable128[k01]);
    }
